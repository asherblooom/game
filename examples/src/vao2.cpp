...
int main(void)
{
	...
	const vertexData vertices[] = {
		{0, 0, 0, 1, 0, 0}, {0.5, 0.5, 0, 0, 1, 0}, {0, 0.5, 0.5, 0, 0, 1}};
	GLuint buffer;
	...
	glVertexAttribPointer(
		0, 3, GL_FLOAT, GL_FALSE, sizeof(vertexData), (void*)offsetof(vertexData, x));
	glVertexAttribPointer(
		1, 3, GL_FLOAT, GL_FALSE, sizeof(vertexData), (void*)offsetof(vertexData, r));
