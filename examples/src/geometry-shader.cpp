...
int main(void) {
	...
	GLFWwindow* window = glfwCreateWindow(
		SCR_WIDTH, SCR_HEIGHT, "Geometry Shader Example", NULL, NULL);
	if (window == NULL) {
...
GLuint compile_shaders(void) {
	...
	static const GLchar* geometry_shader_source = R"glsl(
		#version 430 core
