...
int main(void)
{
	...
	// create window
	GLFWwindow* window =
		glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Moving Triangle Example", NULL, NULL);
	if(window == NULL)
	{
	...
	while(!glfwWindowShouldClose(window))
	{
		...
		GLfloat attrib[] = {std::sin(time) * 0.5f, std::cos(time) * 0.6f, 0.0f, 0.0f};
...
GLuint compile_shaders(void)
{
	...
	static const GLchar* vertex_shader_source = R"glsl(
		...
		// set the offset variable to location 0
